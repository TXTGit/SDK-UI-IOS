...
/**
 *  Indicates push method
 */
@property(readonly, nonatomic) EKandyEventPushMethod pushMethod;
 ...
 */
-(id) initWithCallId:(NSString*)callId uuid:(NSString*)aUUID caller:(KandyRecord*)aCaller callType:(EKandyCallType)aCallType isVideo:(BOOL)aIsVideo timestamp:(NSDate*)aTimestamp via:(NSString*)aVia origin:(EKandyEventOrigin)anOrigin pushType:(EKandyEventPushType)pushType pushMethod:(EKandyEventPushMethod)pushMethod;
