 ...
 *
 *  @param eventUUIDs       a list of UUID of the events to Ack
 *  @param responseCallback a callback containing a possible error
 */
-(void) markEventsAsReceived:(NSArray<NSString*>* _Nonnull)eventUUIDs responseCallback:(void(^ _Nullable)(NSError * _Nullable error))responseCallback;
