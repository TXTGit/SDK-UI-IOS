...
/**
 *  Send event received acknowledgments automatically.
 *
 *  As default is YES
 */
@property(nonatomic, assign) BOOL isEnableEventsAutomaticAck;
 ...
 *
 *  NSURLRequestReloadIgnoringCacheData as default
 *
 */
@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
/*
 * Allow NSURLConnection caching data to Memory
 *
 * As default is NO
 *
 */
