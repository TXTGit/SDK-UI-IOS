...
/**
 *  The push method for event
 */
typedef NS_ENUM(NSUInteger, EKandyEventPushMethod) {
    /**
     *  Push method is unknown
     */
    EKandyEventPushMethod_None,
    /**
     * Push method which is received from APNS
     */
    EKandyEventPushMethod_Native,
    /**
     * Push method which is received from Websocket
     */
    EKandyEventPushMethod_Kandy,
};
...
extern "C" {
    ...
    NSString* EKandyCallPushMethodToString(EKandyEventPushMethod method);
