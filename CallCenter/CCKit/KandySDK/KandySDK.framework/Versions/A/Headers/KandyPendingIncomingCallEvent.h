 ...
 */
-(id) initWithCallId:(NSString*)aCallId caller:(KandyRecord*)aCaller callType:(EKandyCallType)aCallType isVideo:(BOOL)aIsVideo timestamp:(NSDate*)aTimestamp via:(NSString*)aVia sdp:(NSString*)sdp origin:(EKandyEventOrigin)origin pushType:(EKandyEventPushType)pushType pushMethod:(EKandyEventPushMethod)pushMethod;
